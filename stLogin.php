...
require_once 'includes/conn.php';
    ...
    //echo "<script type='text/javascript'>alert('Session shown');</script>";
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $stmt = $pdo->prepare("SELECT * from staffusers where userid=? and password=?");
        ...
        //echo "executed";
            ...
            header('Location: http://localhost/skool/StaffLogin.php');
        }

        else{
            $message = "Wrong Username/Password";
            echo "<script type='text/javascript'>alert('$message');</script>";
                header('Location: http://localhost/skool/stLogin.php');  
        }
}
}
